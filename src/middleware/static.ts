...
const _static = (state: State): Denoot.StaticCallback =>
    async (routes: Denoot.DeclarePath, options: Denoot.StaticRouteOptions) => {
        ...
        const staticProvider = async (_path: string) =>
            async (req: Denoot.Request, res: Denoot.Response, next: Denoot.Next) => {
